...
class _AlertCenterListState extends State<AlertCenterList> {
  ...
  void initState() {
    super.initState();
    SharedPreferencesHandler().getString('authToken').then((value) => _getEarlyWarn(value));
  }
  ...
  void _getEarlyWarn(String token) async {
    ...
    var earlyWarnResp = await Subroutines.getEarlyWarning(token);
              ...
              children: [
                Column(
                  ...
                  children: const <Text> [
                    ...
                    Text('Early Warnings', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600))
                  ],
                ),
                            ...
                            children: [
                              Row(
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                                      color: Subroutines.getRiskColor(item['riskScore']),
                                  ...
                                  Container(
                                    ...
                                    child: Text(Subroutines.getRiskLevel(item['riskScore']).toString(), style: TextStyle( fontWeight: FontWeight.w600, color: Subroutines.getRiskColor(item['riskScore'])),),
                                  ),
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  Text('v${item['version']}'),
                                  const SizedBox(width: 10),
                                  Text(Subroutines.getDate(item['publishAt']))
                                ],
                              )
                            ],
                          ),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                width: 40,
                                height: 40,
                                child: Text(item['riskScore'].toString(), textAlign: TextAlign.center,
